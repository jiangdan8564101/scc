...
//    uint8_t *purchase_info_bytes = (uint8_t*)base64_decode([purchase_info_string cStringUsingEncoding:NSASCIIStringEncoding],
//                                                           &purchase_info_length);
//    
//    size_t signature_length;
//    uint8_t *signature_bytes = (uint8_t*)base64_decode([signature_string cStringUsingEncoding:NSASCIIStringEncoding],
//                                                       &signature_length);
//    
//#pragma pack(push, 1)
...
{
    size_t retLen;
    uint8_t *retStr = (uint8_t*)base64_decode([input UTF8String], &retLen);
    if (length)
...
void* base64_decode(const char* s, size_t* data_len_ptr)
{
    ...
    if (len % 4)
        [NSException raise:@"Invalid input in base64_decode" format:@"%ld is an invalid length for an input string for BASE64 decoding", len];
